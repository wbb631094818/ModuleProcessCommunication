...
import com.photo3d.dbdeno.bean.User;
...
public class UserDb {
    ...
    public User queryData() {
        try {
            return dbManager.selector(User.class).findFirst();
        } catch (DbException e) {
            e.printStackTrace();
        }
        return null;
     ...
     * @return
     */
    public ArrayList<User> queryDataAll() {
        try {
            return (ArrayList<User>) dbManager.selector(User.class).findAll();
        } catch (DbException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public void addData(User user) {
        try {
            ...
            e.printStackTrace();
            Log.e("wbb", "addData: DbException: "+e.getMessage() );
        }
    }
}
